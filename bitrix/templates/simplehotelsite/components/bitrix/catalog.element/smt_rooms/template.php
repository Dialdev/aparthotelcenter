    ...
    <div class="row">
        ...
        <?if(!empty($arParams['BUTTON_LIST'])):?>
            <div class="smt-widget smt-widget_margin">
                ...
                <?endforeach?>
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <a href="#" data-tl-booking-open='true' data-tl-room='<?=$arResult["PROPERTIES"]["ID_BRON"]["VALUE"]?>' class="btn btn-block smt-btn ">Забронировать</a>
                        </div>
                </div>
            </div>
        <?endif;?>
        <?if(!empty($arResult['PROPERTIES']) && is_array($arParams['MAIN_BLOCK_PROPERTY_CODE'])):?>
            <table class="table">
