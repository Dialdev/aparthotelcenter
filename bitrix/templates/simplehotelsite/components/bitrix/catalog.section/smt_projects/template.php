                ...
                <div class="smt-project-item__container">
                    ...
                    <a class="smt-project-item__content" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                        ...
                        <div class="smt-project-item__property">
                            <?if(!empty($arItem['PROPERTIES']) && is_array($arParams['MAIN_BLOCK_PROPERTY_CODE'])):?>
                            ...
                            <?if($arItem["PROPERTIES"]["PRICE_TEXT"]["VALUE"]):?>
                                ...
                                <?endif;?>
                                <?unset($property);?>
                            <?elseif($arItem["PRICES"]["PRICE"]["VALUE"]):?>
                                ...
                                <?else:?>
                                    <span class="smt-price-label"><?=$arParams["PRICE_HEADER"]?$arParams["PRICE_HEADER"]:GetMessage("SMT_BPSC_HEADER_PRICE")?></span>
                                    <span class="smt-price"><span class="smt-price-value"><?=smtCatalogCurrencyFormat($arItem["PRICES"]["PRICE"]["VALUE"], $arParams["CURRENCY_DECIMALS"], $arParams["CURRENCY_DECIMALS_POINT"], $arParams["CURRENCY_THOUSANDS_SEP"]);?></span> <span class="smt-price-currency"><?=$arParams["CURRENCY"]?$arParams["CURRENCY"]:GetMessage("SMT_BPSC_HEADER_CURRENCY")?></span></span>
                                <?endif;?>
                            <?endif;?>
