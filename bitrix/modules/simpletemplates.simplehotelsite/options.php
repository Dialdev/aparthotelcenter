<?
$module_id = "simpletemplates.simplehotelsite";
...
$arAllOptions = array(
    ...
    array("smt_main_show_catalog", GetMessage("SMT_OPTIONS_MAIN_SHOW_CATALOG"), array("checkbox")),
    ...
    array("smt_main_show_advantages", GetMessage("SMT_OPTIONS_MAIN_SHOW_ADVANTAGES"), array("checkbox")),
    array("smt_main_show_gallery", GetMessage("SMT_OPTIONS_MAIN_SHOW_GALLERY"), array("checkbox")),
    array("smt_main_show_workers", GetMessage("SMT_OPTIONS_MAIN_SHOW_WORKERS"), array("checkbox")),
    array("smt_main_show_responses", GetMessage("SMT_OPTIONS_MAIN_SHOW_RESPONSES"), array("checkbox")),
    array("smt_main_show_clients", GetMessage("SMT_OPTIONS_MAIN_SHOW_CLIENTS"), array("checkbox")),
    ...
    array("smt_main_show_map", GetMessage("SMT_OPTIONS_MAIN_SHOW_MAP"), array("checkbox")),
...
$arAllBlocks = array(
    ...
    "catalog" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_CATALOG"),
    "services" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_SERVICES"),
    "about" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_ABOUT"),
    "advantages" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_ADVANTAGES"),
    "gallery" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_GALLERY"),
    "workers" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_WORKERS"),
    "responses" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_RESPONSES"),
    "clients" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_CLIENTS"),
    "action" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_ACTION"),
    "banner" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_BANNER"),
    "news" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_NEWS"),
    "map" => GetMessage("SMT_OPTIONS_MAIN_BLOCKS_MAP"),
);
...
)
{
    ...
    else
    {
        foreach($arSiteList as $site)
        {
            ...
            if(!empty($colorProperties) && is_file($_SERVER["DOCUMENT_ROOT"] . '/bitrix/templates/simplehotelsite/assets/css/colors/template.less')) {
                $parser = new Less_Parser();
                $parser->parseFile($_SERVER["DOCUMENT_ROOT"] . '/bitrix/templates/simplehotelsite/assets/css/colors/template.less');
                $parser->ModifyVars( $colorProperties );
                file_put_contents($_SERVER["DOCUMENT_ROOT"] . '/bitrix/templates/simplehotelsite/assets/css/colors/template_'.$site.'.css', $parser->getCss());
            }
        }
                    ...
                    <?elseif($type[0]=="colorbox"):?>
                        ...
                        $APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "UNSHIFT_PALETTE" => array("#6fb586", "#5bcab1", "#cf608b", "#1ba3f2", "#ff5951", "#ffe42e"),
                            )
                        );
                        ?>
