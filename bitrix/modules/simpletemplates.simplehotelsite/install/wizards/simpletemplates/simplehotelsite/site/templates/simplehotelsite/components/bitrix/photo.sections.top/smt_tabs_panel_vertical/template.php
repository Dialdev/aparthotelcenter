			...
			<?foreach($arSection["ITEMS"] as $arItem):?>
				...
				<div class="panel smt-panel-primary" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="panel-heading">
						<div class="panel-title"><a name="smt-accordion-primary-item-<?=$arItem['ID']?>"></a><a data-toggle="collapse" href="#smt-accordion-primary-item-<?=$arItem['ID']?>"><?=$arItem["PREVIEW_TEXT"]?></a></div>
					</div>
							...
							<div class="row">
								...
								<div class="<?=implode(' ', $arResult["LINE_ELEMENT_GRID"][1])?>">
									...
									<div class="smt-blog-item__content">
										...
										<?endif;?>
										<?if($arParams["DISPLAY_DETAIL_TEXT"] == "Y"):?>
											<div class="smt-blog-item__text">
