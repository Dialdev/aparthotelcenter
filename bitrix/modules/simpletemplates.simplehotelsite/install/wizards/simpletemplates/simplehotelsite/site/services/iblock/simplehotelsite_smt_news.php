...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/simplehotelsite_smt_news.xml";
$iblockCode = "simplehotelsite_smt_news_" . WIZARD_SITE_ID;
$iblockCodeOriginal = "simplehotelsite_smt_news";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."smt_include/main_news.php", array("SMT_NEWS_IBLOCK_ID" => $iblockID));;
