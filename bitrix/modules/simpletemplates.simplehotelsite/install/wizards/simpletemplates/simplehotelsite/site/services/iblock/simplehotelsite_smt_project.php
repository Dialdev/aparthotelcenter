...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/simplehotelsite_smt_project.xml";
$iblockCode = "simplehotelsite_smt_project_" . WIZARD_SITE_ID;
$iblockCodeOriginal = "simplehotelsite_smt_project";
...
include_once('simplehotelsite_project_after.php');
