...
class SelectSiteStep extends CSelectSiteWizardStep
{
    function InitStep()
    {
        ...
        $wizard->solutionName = "simplehotelsite";
    }
}
...
"SITE_EMAIL" => GetMessage("WIZ_SITE_EMAIL_DEF"),
...
//install Demo data
    ...
    {
        $wizard =& $this->GetWizard();
        $res = $this->SaveFile("siteLogo", Array("extensions" => "gif,jpg,jpeg,png", "max_height" => 350, "max_width" => 350));
    }
}
