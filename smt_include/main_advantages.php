<section class="smt-widget smt-widget_padding">
	<div class="container">
		<?$APPLICATION->IncludeFile(
			SITE_DIR."smt_include/main_advantages_header.php",
			Array(),
			Array("MODE"=>"html")
		);?>
		<?$APPLICATION->IncludeComponent("bitrix:news.list", "smt_benefit_list", array(
	"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "Y",
		"DISPLAY_PICTURE" => "Y",
		...
		"COMPONENT_TEMPLATE" => "smt_benefit_list",
		...
		"PICTURE_RESIZE_WIDTH" => "50",
		"PICTURE_RESIZE_HEIGHT" => "50",
		"SMT_SLIDER" => "N",
		"SMT_SLIDER_ITEMS" => "2",
		"SMT_SLIDER_MARGIN" => "",
		"SMT_SLIDER_NAV" => "N",
