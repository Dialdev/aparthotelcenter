<section class="smt-widget smt-widget_padding smt-widget-about">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <? if (COption::GetOptionString('simpletemplates.simplehotelsite', 'smt_main_show_services', 'Y', SITE_ID) == "Y"): ?>
	...
	false
                    ...
                    <? $APPLICATION->IncludeComponent("bitrix:news.list", "smt_news", array(
	"DISPLAY_DATE" => "N",
		"DISPLAY_NAME" => "Y",
		"DISPLAY_PICTURE" => "Y",
		...
		"PICTURE_RESIZE_WIDTH" => "350",
		"PICTURE_RESIZE_HEIGHT" => "350",
		"SMT_SLIDER" => "N",
		"SMT_SLIDER_ITEMS" => "2",
		"SMT_SLIDER_MARGIN" => "",
		"SMT_SLIDER_NAV" => "N",
